      ...
      builder: (profile) => Scaffold(
        ...
        body: ListView(
          children: [
                ...
                children: [
                  Positioned(
                    ...
                    child: GestureDetector(
                      onTap: ()=>  Navigator.push(context, CupertinoPageRoute(builder: (_) => ProfileScreen(user: APIs.me))),
            ...
            Column(
              children: [
                Text(APIs.me.name.isNotEmpty ? APIs.me.name : APIs.me.email, style: robotoBold.copyWith(color: MyColor.getTextColor(), fontSize: MySizes.fontSizeOverLarge)),
               const SizedBox(height: 2),
