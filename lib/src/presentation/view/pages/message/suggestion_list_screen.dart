                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ClipOval(
                                child: Image.asset(MyImage.image5, height: 45,width: 45,fit: BoxFit.cover,),
                              ),
                              const SizedBox(width: 12),
                              Expanded(
                                  child: Column( crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text(snapshot.child('username').value.toString(), style: robotoBold.copyWith(color: MyColor.getTextColor(), fontSize: MySizes.fontSizeDefault)),
